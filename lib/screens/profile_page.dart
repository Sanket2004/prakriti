...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _updateProfilePicture(String name) {
    final String newImageUrl =
        'https://api.dicebear.com/9.x/initials/png?seed=${Uri.encodeComponent(name)}';
    setState(() {
      _userData!['avatar'] = newImageUrl;
    });
  }
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            onChanged: (value) {
                              ...
                              _updateProfilePicture(
                                  value); // Update profile picture URL
                            },
                          ...
                          TextFormField(
                            style: const TextStyle(
                                fontSize: 14, color: Colors.black),
                            initialValue: _userData!['total_area'],
                            readOnly: !_editable,
                            keyboardType: TextInputType.text,
                            onChanged: (value) {
                              setState(() {
                                _userData!['total_area'] = value;
                              });
                            },
                            decoration: InputDecoration(
                              contentPadding: const EdgeInsets.all(0),
                              hintText: 'Total area of land',
                              hintStyle: TextStyle(
                                  color: Colors.grey.shade500,
                                  fontWeight: FontWeight.w300),
                              border: _editable
